...
export function permissionForDashboard(method: string | undefined): PermissionKey | null {
  if (method === 'GET') return 'read:dashboard';
  if (method === 'POST' || method === 'PATCH') return 'write:dashboard';
  return null;
}
